...
const VeXe =()=>{
            ...
            selector: (row, index)=>{
                return(
                    ...
                    <div style={{margin: "10px"}}>
                        <Button onClick={()=>redirect(row)} style={{margin:"10px", backgroundColor:"#00FF99", color: "black"}}>{t("quanlyvexe")}</Button>
                    </div>
                    </>
                );
            },
    ...
    return(
        <>
        <div style={{textAlign: "center", marginBottom:"30px", marginTop:"20px"}}><h2>{t("quanlyvexe")}</h2></div>

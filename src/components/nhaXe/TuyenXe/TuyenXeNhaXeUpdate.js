                ...
                <Card className="shadow">
                    ...
                    <div className="mb-3 mt-md-4">
                        ...
                        <Form>
                        {
                            ...
                            <Form.Select id="xe">
                                {xe.map(x=>{
                                    if(x.id_nhaXe==idTaiKhoanNhaXe &&x.id==idXe){
                                        return(
                                            <option key={`xe${x.id}`} selected value={x.id}>Biển số xe: {x.bienSoXe} - Nhà xe {tenNhaXe}</option>
                                        )
                                    }
...
export default TuyenXeNhaXeUpdate;